...
static io::RelaysCollection<RelayACLowId> ac_low_relays({
    ...
    {RelayACLowId::ZAWOR_LM_PLUS_PRECYZYJNY_ZAMKNIECIE, io::GpioPin(O_AC_4_GPIO_Port, O_AC_4_Pin)},
    {RelayACLowId::ZAWOR_LM_SAM_OTWARCIE, io::GpioPin(O_AC_5_GPIO_Port, O_AC_5_Pin)},
    {RelayACLowId::ZAWOR_LM_SAM_ZAMKNIECIE, io::GpioPin(O_AC_6_GPIO_Port, O_AC_6_Pin)},
    {RelayACLowId::LAMPA, io::GpioPin(O_AC_7_GPIO_Port, O_AC_7_Pin)},
    {RelayACLowId::WOLNY, io::GpioPin(O_AC_8_GPIO_Port, O_AC_8_Pin)}
});
