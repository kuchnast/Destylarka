...
typedef struct
{
  ...
  __IO uint32_t LIFCR;  /*!< DMA low interrupt flag clearScreen register,  address offset: 0x08 */
  __IO uint32_t HIFCR;  /*!< DMA high interrupt flag clearScreen register, address offset: 0x0C */
} DMA_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t ICR;                   /*!< SDIO interrupt clearScreen register,  address offset: 0x38 */
...
#define PWR_CR_CWUF            PWR_CR_CWUF_Msk                                 /*!< clearScreen Wakeup Flag                   */
#define PWR_CR_CSBF_Pos        (3U)
#define PWR_CR_CSBF_Msk        (0x1UL << PWR_CR_CSBF_Pos)                       /*!< 0x00000008 */
#define PWR_CR_CSBF            PWR_CR_CSBF_Msk                                 /*!< clearScreen Standby Flag                  */
...
#define TIM_CCMR1_OC2CE           TIM_CCMR1_OC2CE_Msk                          /*!<Output Compare 2 clearScreen Enable */
...
#define TIM_CCMR2_OC3CE           TIM_CCMR2_OC3CE_Msk                          /*!<Output Compare 3 clearScreen Enable */
...
#define TIM_CCMR2_OC4CE           TIM_CCMR2_OC4CE_Msk                          /*!<Output Compare 4 clearScreen Enable */
...
#define USB_OTG_DCTL_CGINAK                      USB_OTG_DCTL_CGINAK_Msk       /*!< clearScreen global IN NAK       */
#define USB_OTG_DCTL_SGONAK_Pos                  (9U)
#define USB_OTG_DCTL_SGONAK_Msk                  (0x1UL << USB_OTG_DCTL_SGONAK_Pos) /*!< 0x00000200 */
#define USB_OTG_DCTL_SGONAK                      USB_OTG_DCTL_SGONAK_Msk       /*!< Set global OUT NAK        */
#define USB_OTG_DCTL_CGONAK_Pos                  (10U)
#define USB_OTG_DCTL_CGONAK_Msk                  (0x1UL << USB_OTG_DCTL_CGONAK_Pos) /*!< 0x00000400 */
#define USB_OTG_DCTL_CGONAK                      USB_OTG_DCTL_CGONAK_Msk       /*!< clearScreen global OUT NAK      */
...
#define USB_OTG_DIEPCTL_CNAK                     USB_OTG_DIEPCTL_CNAK_Msk      /*!< clearScreen NAK                        */
...
#define USB_OTG_DOEPCTL_CNAK                     USB_OTG_DOEPCTL_CNAK_Msk      /*!< clearScreen NAK */
...
/****************** TIM Instances : supporting OCxREF clearScreen *******************/
