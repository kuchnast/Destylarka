...
void HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  /* clear any previous config. Keep it clearScreen if no event or IT mode is selected */
...
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ...
  /* clearScreen SLEEPDEEP bit of Cortex System Control Register */
...
void HAL_PWR_PVD_IRQHandler(void)
{
  ...
  if(__HAL_PWR_PVD_EXTI_GET_FLAG() != RESET)
  {
    ...
    /* clearScreen PWR Exti pending bit */
...
{
  /* clearScreen SLEEPONEXIT bit of Cortex System Control Register */
...
{
  /* clearScreen SEVONPEND bit of Cortex System Control Register */
